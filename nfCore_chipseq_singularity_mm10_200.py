...
from carlos_nfcFunctions import process_sample_sheet, update_yaml, slurm_writer, process_atac_sheet, process_chip_sample_sheet_200
...
sample_sheet = process_chip_sample_sheet_200(sample_sheet)
...
if len(args.msheet) < 2:
    ...
    if 'fastq_2' in merged_df.columns:
        merged_df = merged_df[['sample', 'fastq_1', 'fastq_2','antibody','control','sampleID']]
    else:
        merged_df = merged_df[['sample', 'fastq_1','antibody','control','sampleID']]
    ...
    shell = "nextflow run \\\n"+
    "/project/imoskowitz/shared/software/nf-core-chipseq_2.0.0/2_0_0 -work-dir "+'/scratch/midway3/'+os.getlogin()+"/working_"+seqrunid+ " \\\n"+
    ...
    'export NXF_SINGULARITY_CACHEDIR="/project/imoskowitz/shared/software/singularityImages"', 
    shell = "nextflow run \\\n"+
    "/project/imoskowitz/shared/software/nf-core-chipseq_2.0.0/2_0_0 -work-dir "+'/scratch/midway3/'+os.getlogin()+"/working_"+expid+ " \\\n"+
    "-profile singularity -params-file "+args.out+"/"+expid+"/chipseq_params.yaml -c /project/imoskowitz/shared/software/assets/test4.config \n")
